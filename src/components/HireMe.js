...
export default function HireMe(){
    ...
    return(
    <section className="hireme bg-dark card">
        <span className="my-4 mx-3 text-center">
            <em>
               To know more about me and my work :
            </em>
        </span>
        <div className="hire-div d-flex flex-column  align-items-center justify-content-center py-5 px-5 ">
            <div className="d-flex justify-content-between align-items-center">
            <span className="mx-3">Connect via LinkedIn</span>
            <a href="https://www.linkedin.com/in/simmyvarghese/" target="_blank" rel="noreferrer"><i
